  ...
  render() {
    return (
      <View style={styles.container}>
       <ImageBackground source={this.state.videoOn ? require('../../images/Index.png') : require('../../images/BlocoE.png')} style={{width: '100%', height: '100%'}}>
        { this.state.videoOn 
          ? 
            <Video
                  source={require('../../video/BlocoE.mp4')}
                  rate={1.0}
                  volume={1.0}
                  isMuted={false}
                  resizeMode="cover"
