...
export default class BlocoBP2 extends React.Component {
  ...
  renderPart(){
    switch(this.state.part){
      case 0:
        return(
              <ImageBackground source={require('../../imagens/Pisos/BlocoB1P2.png')} style={{width: '100%', height: '100%'}}>
                <NewHeader></NewHeader>
                  <Icon.Button 
      ...
      case 1:
            ...
            <ImageBackground source={require('../../imagens/Pisos/BlocoB2P2.png')} style={{width: '100%', height: '100%'}}>
      ...
      case 2:
            return(    
            <ImageBackground source={require('../../imagens/Pisos/BlocoB3P2.png')} style={{width: '100%', height: '100%'}}>
                <NewHeader></NewHeader>
                <Icon.Button 
                        backgroundColor={'transparent'}
                        color={'#dee9fc'}size={30} style ={header.icon}
