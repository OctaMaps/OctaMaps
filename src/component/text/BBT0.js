...
import { withNavigationFocus,NavigationEvents } from 'react-navigation';
 ...
 class BBT0 extends React.Component {
    ...
    return (
      <View style={{marginLeft: '0%'}}>
        ...
        <View style={{marginTop: '0%'}}>
           ...
           <Text style={t.a2}> {b.slice(0,10)} </Text>
           <Text style={t.a2}> {b.slice(10,20)} </Text>
           <Text style={t.a2}> {b.slice(20,40)} </Text>
           </View>
           ...
           <Text style={t.a5}> {e.slice(9,20)} </Text>
           <Text style={t.a5}> {e.slice(20,40)} </Text>
...
export default withNavigationFocus(BBT0)
