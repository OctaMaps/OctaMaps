...
import { withNavigationFocus,NavigationEvents } from 'react-navigation';
 ...
 class BP2E extends React.Component {
    ...
    return (
      <View style={{marginLeft: '0%'}}>
        ...
        <View style={{marginTop: '0%'}}>
           ...
           <View style={{marginTop: '20%'}}>
           <Text style={t.a5}> {e.slice(0,10) }</Text>
           <Text style={t.a5}> {e.slice(10,23)} </Text>
           <Text style={t.a5}> {e.slice(23,40)} </Text>
...
export default withNavigationFocus(BP2E)
